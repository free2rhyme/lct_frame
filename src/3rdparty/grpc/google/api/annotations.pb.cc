...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "annotations.proto", schemas, file_default_instances, TableStruct::offsets, factory,
      NULL, NULL, NULL);
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::api::protobuf_http_2eproto::InitDefaults();
...
void AddDescriptorsImpl() {
  ...
  ::google::api::protobuf_http_2eproto::AddDescriptors();
