...
LCT_ERR_CODE CLctMongoConnPool::init()
{
    ...
    try{
        ...
        m_mongoPool.reset(new CMongoPool(mgUrl));
...
LCT_ERR_CODE CLctMongoHelper::setConnCount(const int32_t connMaxCount)
{
...
bool CLctMongoHelper::CMongoDriverStamp::operator==(const CMongoDriverStamp& that) const
{
