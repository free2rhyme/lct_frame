 ...
 * @file        lct_mongo_helper.h
 * @version     1.0
 * @date        Jun 23, 2017 3:51:38 PM
 * @author      wlc2rhyme@gmail.com
 * @brief       TODO
 *********************************************************************/
#ifndef SRC_WRAPPER_MONGODB_LCTMONGOHELPER_H_
#define SRC_WRAPPER_MONGODB_LCTMONGOHELPER_H_
...
//typedef bsoncxx::builder::stream::finalize    CMongoBuilderFinalize;
...
private:
    ...
    typedef lct_rw_lock          CConnPoolLock;
...
#include "lct_mongo_helper.hpp"

#endif /* SRC_WRAPPER_MONGODB_LCTMONGOHELPER_H_ */
