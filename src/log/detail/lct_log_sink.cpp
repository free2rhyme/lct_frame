...
LCT_ERR_CODE CRotateFileSink::log(const CLctLogMessageShp& message)
{
    std::lock_guard<CRotateMutex> lk(m_mutex);
    return sinkIt(message);
}

LCT_ERR_CODE CRotateFileSink::sinkIt(const CLctLogMessageShp& message)
{
...
LCT_ERR_CODE CDailyRotateFileSink::log(const CLctLogMessageShp& message)
{
    std::lock_guard<CRotateMutex> lk(m_mutex);
    return sinkIt(message);
}

LCT_ERR_CODE CDailyRotateFileSink::sinkIt(const CLctLogMessageShp& message)
{
    LCT_ERR_CODE errCode = LCT_SUCCESS;
